...
\paragraph{S1 Fig.}
\includegraphics[width=\textwidth]{img/PNG/neuroblastoma-mycn-distribution-comparison-boxplot.png}
\label{S1_Sig}
{\bf \textit{MYCN} distribution for UCSC Treehouse compendium, TARGET neuroblastoma cohort, and the TARGET neuroblastoma cohort subset by \textit{MYCN} amplification status.} 
...
\label{S5_Fig}{\bf Hydra \textit{sweep} analysis reveals differential pathway expression with MYCN-NA neuroblastoma without a matched cohort of normal tissue.}
...
\label{S6_Fig} {\bf Hydra method correlates with distinct tumor features as assessed by licensed pathologist review of tumor H\&E slides.}
