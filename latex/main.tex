...
Once we have the mixing components, we want to sample parameters from the centering distribution $H$ at the frequency of the mixing components. 
...
Then $G$ follows a Dirichlet process prior parameterized by concentration parameter $\alpha$ and centering parameter $H$. This construction generates cluster-specific parameters $\mu_k$ and $\Sigma_k$.
