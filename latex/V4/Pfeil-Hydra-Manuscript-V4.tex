...
\begin{figure}[h!]
	...
	\caption{{\bf Overview of the hydra framework tools.}
		...
		\textit{sweep} command looks for multivariate normal clusters within user-defined gene sets. This can be used for the automatic detection of clusters in large gene set databases. Abbreviations: Tumor microenvironment (TME) 
		\label{overview}}
\end{figure}
...
We would like to thank the patients and families who participate in pediatric oncology research.
...
\begin{thebibliography}{10}
	...
	\newblock {{DGIdb}} 3.0: A Redesign and Expansion of the Drug\textendash{}Gene
