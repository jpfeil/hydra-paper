...
\begin{figure}
\centering
\includegraphics[width=\linewidth]{images/xist-fig.png}
...
\begin{figure}
\centering
\includegraphics[width=\linewidth]{images/neuroblastoma-mycn-distribution-comparison-boxplot-2017-12-28.png}
\caption{TEXT}
\label{fig:mycn}
\end{figure}
